# Spawnify MVP - Complete Technical Specification
...
12. [Development Priorities](#development-priorities)
...
Spawnify is a production-ready web application that enables mushroom growers to track their cultivation progress while contributing to a scientific dataset. The platform collects detailed environmental and methodological data for:
...
**Target:** 100-6,000 users in 12 months  
**Data Goal:** Scientific-grade cultivation dataset
...
- **Purpose:** Scientific mushroom cultivation tracking platform
- **Target Users:** Home mushroom growers (hobbyists to enthusiasts)
...
Hover: Border → primary-400, shadow-lg with primary tint
```
...
#### Icons
- **Library:** Lucide React (premium icon set)
...
- `/dashboard/grow-logs` - Logs list
- `/dashboard/grow-logs/new` - Create new log
- `/dashboard/grow-logs/[id]` - View/edit log
...
- `/admin/grow-logs` - All grow logs management
...
8. **Inoculation Details** (text input)
...
10. **TEK & Technique Section** (collapsible)
