...
interface PhotoUploadWithExistingProps {
  newPhotos: File[]
...
export function PhotoUploadWithExisting({ 
  newPhotos, 
  existingPhotos,
  onNewPhotosChange,
  onExistingPhotosChange 
}: PhotoUploadWithExistingProps) {
  ...
  function handleFiles(files: File[]) {
    ...
    if (validFiles.length > 0) {
      onNewPhotosChange([...newPhotos, ...validFiles])
    }
  }
  ...
  return (
    <div className="space-y-4">
      ...
      {existingPhotos.length > 0 && (
        <div>
          <p className="text-sm font-medium text-neutral-600 mb-3">Existing Photos</p>
      ...
      {newPhotos.length > 0 && (
        <div>
          <p className="text-sm font-medium text-neutral-600 mb-3">New Photos</p>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
